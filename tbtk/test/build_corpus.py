...
if __name__ == "__main__":
    ...
    en_ud_path = os.path.expanduser('~/projects/treebanks/en-ud/')
    ...
    zh_ud_path = os.path.expanduser('~/projects/treebanks/zh-ud/')
    ...
    ctb51_zc_path = os.path.expanduser('~/projects/treebanks/ctb51_zhang_clark/')
    ...
    ctb51_path = os.path.expanduser('~/projects/treebanks/ctb51/')
    ...
    ptb_path = os.path.expanduser('~/projects/treebanks/ptb/')
