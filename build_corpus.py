...
if __name__ == "__main__":
    ...
    en_ud_path = os.path.expanduser('./treebanks/en-ud/')
    ...
    zh_ud_path = os.path.expanduser('./treebanks/zh-ud/')
    ...
    #ctb51_zc_path = os.path.expanduser('./ctb51_zhang_clark/')
    ...
    #ctb51_path = os.path.expanduser('./ctb51/')
    ...
    #ptb_path = os.path.expanduser('./ptb/')
    ...
    for reader in chain(en_ud, zh_ud): # add if needed ctb51_zc, ctb51, ptb
        reader.save()
