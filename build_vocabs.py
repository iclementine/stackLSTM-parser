...
if __name__ == "__main__":
    ...
    en_ud_train_path = os.path.expanduser("~/projects/treebanks/en-ud/en-ud-train.pickle") # if use ~ for home path

    train_paths = [zh_ud_train_path, en_ud_train_path, ctb51_train_path, ctb51_zc_train_path, ptb_train_path] # add if needed
